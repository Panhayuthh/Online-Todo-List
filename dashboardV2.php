                    ...
                    <div class="col">
                        ...
                        <div class="card-header bg-danger-subtle"></div>
                            <div class="card-body">
                                ...
                                <p class="card-text">Total Tasks:</p>
                                <?php
                                    $query = ("SELECT COUNT(*) AS task_count FROM task t JOIN to_do_list l ON t.todo_list_id = l.id WHERE l.user_id = ? AND t.status = 'Not Started' OR t.status = 'In Progress'");
